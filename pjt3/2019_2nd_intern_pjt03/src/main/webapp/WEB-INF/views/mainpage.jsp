...
<body>
	<div id="container">
		...
		<div class="event">
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min" id='category'>
				</ul>
			</div>
			<div class="section_event_lst">
				<p class="event_lst_txt">
					바로 예매 가능한 행사가 <span class="pink"></span>개 있습니다
				</p>
				<div class="wrap_event_box">
					<!-- [D] lst_event_box 가 2컬럼으로 좌우로 나뉨, 더보기를 클릭할때마다 좌우 ul에 li가 추가됨 -->
					<ul class="lst_event_box" id='leftProductContainer'>
					</ul>
					<ul class="lst_event_box" id='rightProductContainer'>
					</ul>
					<div class="more">
						<button class="btn">
							<span>더보기</span>
    ...
    <li class="item" style="background-image:url(/reservation/{promotionUrl});">
	...
	<script type="rv-template" id="categoryList">
		<li class="item" id ="{id}" data-category="{id}" data-count="{count}">
