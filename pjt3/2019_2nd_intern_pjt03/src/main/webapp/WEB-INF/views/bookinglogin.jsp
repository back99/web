...
<body class="biz  ko">
		...
		<div class="booking_login">
			...
			<div>
				<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
					onSubmit="return formValidate()" action="/reservation/login"
					method="get">
	...
	<script type="text/javascript">
		function formValidate() {
			...
			const emailData = document.confirm_form.resrv_email.value;
			if ((emailData != '' && emailData != 'undefined' && emailRegex.test(emailData))) {
				return ;
			} else {
				alert('입력이 잘못되었습니다.')
			}
