...
<body>
		...
		<div class="ct main">
			<div>
				<div class="section_visual">
					...
					<div class="pagination">
						...
						<div class="figure_pagination">
							<span class="num" id="slideNum">1</span> <span class="num off">/ <span>2</span></span>
						</div>
					</div>
				...
				<div class="section_review_list">
					...
					<a class="btn_review_more"> <span>예매자 한줄평 더보기</span> <i
	...
	<script type='text/javascript' src='/reservation/js/detailpage.js'></script>
	<script type='text/javascript' src='/reservation/js/ajaxerror.js'></script>
	<script type='text/javascript' src='/reservation/js/commondraw.js'></script>
	<script type='text/javascript'>
		detailpage.detailPageInit("${dispalyInfoId}");
