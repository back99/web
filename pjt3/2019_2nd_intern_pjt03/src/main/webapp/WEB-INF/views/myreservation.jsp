...
<body>
			...
			<div class="section_my">
				...
				<div class="wrap_mylist">
					<ul class="list_cards" ng-if="bookedLists.length > 0">
						...
						<li class="card confirmed" id="confirmed_list">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
						...
						<li class="card used" id="finished_list">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
						...
						<li class="card used cancel" id="cancel_list">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
	...
	<div class="popup_booking_wrapper" style="display: none;">
		...
		<div class="popup_booking refund">
			...
			<div class="pop_bottom_btnarea">
				<div class="btn_gray">
					<a href="#" class="btn_bottom" id="no_btn"><span>아니오</span></a>
				</div>
				<div class="btn_green">
					<a href="#" class="btn_bottom" id="yes_btn"><span>예</span></a>
				</div>
			</div>
			<!-- 닫기 -->
	...
	<script type="text/javascript" src="/reservation/js/jquery.cookie.js"></script>
	<script type='text/javascript' src='/reservation/js/ajaxerror.js'></script>
	<script type='text/javascript' src='/reservation/js/myreservation.js'></script>
	<script type='text/javascript'>
		
		const emailCookie = $.cookie('email');
		$('.viewReservation').text(emailCookie);
		myreservation.myreservationPageInit();
