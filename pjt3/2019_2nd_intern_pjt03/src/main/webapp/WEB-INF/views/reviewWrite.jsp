...
<body>
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="/reservation/myreservation" class="btn_back"
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<div class="guide_review">
							<span id="writing_count">0</span>/400 <span>(최소5자이상)</span>
						</div>
					</div>
	...
	<script type='text/javascript' src='/reservation/js/reviewWrite.js'></script>
	<script type='text/javascript'>
		reviewWrite.reviewWritePageInit("${reservationInfoId}", "${title}");
	</script>
</body>
</html>