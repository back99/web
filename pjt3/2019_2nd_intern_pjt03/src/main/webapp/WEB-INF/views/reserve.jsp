...
<body>
	<div id="container">
		...
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
					<a href="./detail.jsp" class="lnk_logo" title="네이버"> <span
						class="spr_bi ico_n_logo">네이버</span>
					</a> <a href="./detail.jsp" class="lnk_logo" title="예약"> <span
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title">
					<a href="./detail.jsp" class="btn_back" title="이전 화면으로 이동"> <i
				...
				<div class="section_store_details">
					<div class="store_details">
						<h3 class="in_tit" id="detail_place_tit">장소</h3>
						<p class="dsc_1" id="detail_place_dsc">
							장소 : <br> 기간 : 2017.2.17.(금)~2017.4.18.(화)
						</p>
						<h3 class="in_tit" id="detail_hours_tit">관람시간</h3>
						<p class="dsc" id="detail_hours_dsc">
							화, 목, 금 일요일 10:00am~06:00pm(입장마감 05:30pm)<br> ‘문화가 있는 날’ 매월
							마지막 주 수요일은 오후 8시까지 연장
						</p>
						<h3 class="in_tit" id="detail_price_tit">요금</h3>
						<p class="dsc" id="detail_price_dsc">
				...
				<form class="form_horizontal" method="post" action="/reservation/api/reservation">
						<!-- <div class="qty">
					...
					<div class="booking_form_wrap">
						<div class="form_wrap">
							...
							<div class="agreement_nessasary help_txt">
						  	...
						  	<form class="form_horizontal" onsubmit="return validate();" name="reserveForm" method="post" action="/login">
								<div class="inline_form">
									<label class="label" for="name"> <span
										class="spr_book ico_nessasary">필수</span> <span>예매자</span>
									</label>
									<div class="inline_control">
										<input type="text" id="email_text" name="name" id="name" class="text"
								...
								<div class="inline_form">
									...
									<div class="inline_control tel_wrap">
										...
										<div class="warning_msg" id ="tel_warning">형식이 틀렸거나 너무 짧아요</div>
									</div>
								</div>
								<div class="inline_form">
									...
									<div class="inline_control tel_wrap">
										<input type="email" name="email" id="email" class="email"
											...
											<div class="warning_msg" id ="email_warning">형식이 틀렸거나 너무 짧아요</div>
									</div>
								</div>
								<div class="inline_form last">
									<label class="label" for="message">예매내용</label>
									<div class="inline_control" id = "reserve_date">
										<p class="inline_txt selected">
											{reserveDate}, 총 <span id="totalCount">0</span>매
										</p>
									</div>
								</div>
							</form>
	...
	<script type='text/javascript' src='/reservation/js/reserve.js'></script>
	<script type='text/javascript' src='/reservation/js/validate.js'></script>
	<script type='text/javascript' src='/reservation/js/ajaxerror.js'></script>
	<script type='text/javascript'>
		reserve.reservePageInit("${dispalyInfoId}");
	</script>
